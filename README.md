This Script you can use with your bar. For different function in my case I use it for shutdown, logout and restart pc. But you can reconfigure the script.
